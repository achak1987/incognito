 ...
 */
class RedistributionStats extends AccumulableParam[MutableHashMap[(Int, Int), Int], ((Int, Int), Int)] {

  def addAccumulator(acc: MutableHashMap[(Int, Int), Int], elem: ((Int, Int), Int)): MutableHashMap[(Int, Int), Int] = {
    val (k1, v1) = elem
   ...
   */
  def addInPlace(acc1: MutableHashMap[(Int, Int), Int], acc2: MutableHashMap[(Int, Int), Int]): MutableHashMap[(Int, Int), Int] = {
   ...
   */
  def zero(initialValue: MutableHashMap[(Int, Int), Int]): MutableHashMap[(Int, Int), Int] = {
    val ser = new JavaSerializer(new SparkConf(false)).newInstance()
    val copy = ser.deserialize[MutableHashMap[(Int, Int), Int]](ser.serialize(initialValue))
    copy.clear()
    copy
  }
}